...
In the main program we move on all the files in loop, and for each file we run new thread that his job is to count the lines, and than we merge together all the result.   
